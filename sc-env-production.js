...
export default {
  ...
  web: {
    ...
    base: 'https://prod.smartclips.app'
  },

  api: {
    base: 'https://prod.smartclips.app/api',
  ...
  oauth: {
    mixer: {
      client: '06b7ea18fe5091b7145677fc2ed2f6fdcc99eca33fb614ff',
    ...
    streamlabs: {
      client: 'xNupHvjAIsy3BnOMvxjjw5xsiNZ0mIqP0EVvGgcK',
