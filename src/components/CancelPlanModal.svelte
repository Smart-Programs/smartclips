      ...
      <div>
        <div
          ...
          <svg
            ...
            fill="none"
            viewBox="0 0 24 24">
            <line x1="0" y1="0" x2="24" y2="24" style="stroke-width:5" />
            <line x1="24" y1="0" x2="0" y2="24" style="stroke-width:5" />
          </svg>
        </div>
        <div class="mt-3 text-center sm:mt-5">
          ...
          <div class="mt-2">
            <p class="text-sm leading-5 text-gray-500">
              Canceling subscription plans is not yet supported. If you would
              like to cancel your plan please contact us at
